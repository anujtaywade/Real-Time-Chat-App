  ...
  return (
    <div className="">
      <div
        className={`${
          !isAbsolute
            ? "border-b shadow-sm fixed top-0 w-full bg-gradient-to-r from-purple-600 to-indigo-600 z-50"
            : null
        }`}
      >
        <h1
        ...
        {!isAbsolute && User && (
          <div>
            <button
              ...
              className="absolute right-12 top-4 text-3xl text-white hover:text-gray-200 transition-all duration-200"
            >
              <FaUserCircle />
            </button>

            {Open && (
              <div className="absolute right-5 top-16 w-56 bg-white border border-gray-100 rounded-2xl shadow-2xl py-3 z-50 animate-fadeIn">
                <button
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50 animate-fadeIn">
            <div className="bg-white rounded-3xl shadow-2xl p-8 w-80 relative">
              ...
              <button
                ...
                className="flex items-center justify-between w-full px-5 py-4 rounded-xl hover:bg-yellow-50 transition-all shadow-md bg-gray-100 group"
              >
                <span className="font-medium">☀️ Light Mode</span>
                <div className="w-5 h-5 rounded-full bg-yellow-400 group-hover:scale-110 transition-transform"></div>
              </button>
            </div>
          </div>
        )}
